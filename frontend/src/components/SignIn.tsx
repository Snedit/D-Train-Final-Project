  ...
  return (
    <div className="min-h-screen w-full bg-[#FFEFE1] flex items-center justify-center px-4 py-10">
      <div className="relative max-w-md w-full">
        ...
        {/* Memphis shapes */}
        <motion.div
          className="absolute -top-6 -left-6 w-20 h-20 rounded-full border-[3px] border-slate-900 bg-[#7BC8FF]"
          animate={{ y: [0, -6, 0] }}
          transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute -bottom-6 -right-6 w-24 h-16 rounded-[999px] border-[3px] border-slate-900 bg-[#FFD447]"
